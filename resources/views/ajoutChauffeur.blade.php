...
<nav class="navbar navbar-expand-lg bg-danger">
  ...
  <p>Bienvenue sur la page ajoutChauffeur</p>
{{-- <div>

     <p class="text-center mb-5 fst-italic">Attention vous êtes sur le point de modifier l'utilisateur n° {{$unUser->id}}.</p>

    {!! Form::open(['url'=>'/modifierUtilisateur','method' => 'POST', 'class' => 'col-md-3 mx-auto shadow-lg p-3 mb-5 bg-body rounded']) !!}
            <div class="mb-3">
