...
<div>
    ...
    {!! Form::open(['url'=>'/ajouterOption','method' => 'POST', 'class' => 'container col-md-3 mx-auto shadow-lg p-3 mb-5 bg-body rounded', 'files' => true]) !!}
            ...
            <div class="d-flex justify-content-center">
                {{ Form::submit('Ajouter la prestation', ['class' => 'btn btn-primary btn-lg mt-5']) }}
            </div>
    {!! Form::close() !!}
</div>
